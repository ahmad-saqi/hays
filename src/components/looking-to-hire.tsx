...
const LookingToHire = () => {
  return (
    <div className="py-16 max-w-screen-xl mx-auto flex justify-center">
      <div className="relative bg-white pl-28 py-6 px-4 rounded-md flex gap-4 items-center max-w-screen-lg">
        ...
        <button className="bg-blue-500 text-white py-1.5 w-48 rounded-sm">
          Find out more
        </button>
      </div>
    </div>
